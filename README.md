...
The motivation: attacker can put your iptables or ufw to fall... but he will not find the hidden kernel module that block external access. Because have a hook to netfilter on kernel land.
